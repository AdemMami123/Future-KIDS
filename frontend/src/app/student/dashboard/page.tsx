        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 sm:h-16">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="text-base sm:text-lg md:text-xl font-bold text-gray-800">EduQuiz</span>
            </div>
            <div className="flex items-center gap-1 sm:gap-2 md:gap-4">
              <span className="hidden md:inline text-sm lg:text-base text-gray-700 truncate max-w-[120px] lg:max-w-none">
                {user?.firstName} {user?.lastName}
              </span>
              <button
                onClick={() => router.push('/dashboard/student/settings')}
                className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 text-xs sm:text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
              >
                <Settings className="w-4 h-4" />
                <span className="hidden sm:inline">Parent Links</span>
              </button>
              <button
                onClick={() => signOut()}
                className="flex items-center gap-1 sm:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 text-xs sm:text-sm text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
      ...
      <div className="py-4 sm:py-6 md:py-8 px-3 sm:px-4 md:px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-sm sm:text-base text-gray-600">Ready to learn something new today?</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            <div className="lg:col-span-2 space-y-4 sm:space-y-6 md:space-y-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4">
                <motion.div
                  ...
                  className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border-2 border-purple-100"
                >
                  ...
                  <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-800 mb-0.5 sm:mb-1">
                    {stats?.overview.totalQuizzes || 0}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-500">Quizzes Completed</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border-2 border-green-100"
                >
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500">Average Score</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border-2 border-blue-100"
                >
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                  ...
                  <div className="text-xs sm:text-sm text-gray-500">Improvement</div>
                </motion.div>
                ...
                <motion.div
                  ...
                  className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-3 sm:p-4 md:p-6 border-2 border-orange-100"
                >
                  <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
              ...
              >
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  ...
                  <button
                    ...
                    className="text-purple-600 hover:text-purple-700 font-semibold flex items-center gap-1 text-sm sm:text-base"
                  >
                  ...
                  {recentAttempts.length === 0 ? (
                    ...
                    recentAttempts.map((attempt) => (
                      <motion.div
                        ...
                        className="bg-white rounded-xl shadow-md p-3 sm:p-4 flex items-center justify-between gap-3"
                      >
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-gray-500">
                            <span className="px-2 py-0.5 sm:py-1 bg-purple-100 text-purple-700 rounded-full text-xs">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
                  ...
                  {upcomingQuizzes.length === 0 ? (
                    ...
                    upcomingQuizzes.map((quiz) => (
                      <motion.div
                        ...
                        className="bg-white rounded-xl shadow-md p-3 sm:p-4 cursor-pointer hover:shadow-lg transition-shadow"
                      >
                        <div className="flex items-start gap-2 sm:gap-3">
                          ...
                          <div className="flex-1 min-w-0">
                            <h3 className="font-semibold text-gray-800 mb-1 line-clamp-1 text-sm sm:text-base">
                              {quiz.title}
                            </h3>
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.5 }}
                className="bg-gradient-to-br from-blue-500 to-purple-600 rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-5 md:p-6 text-white"
              >
                <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">💡 Study Tips</h3>
