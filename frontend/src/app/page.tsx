  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-secondary-50 to-accent-50">
        ...
        >
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-neutral-600 mt-4">
              Interactive Learning Through Engaging Quizzes
            </p>
          </motion.div>
          ...
          >
            Teachers create exciting quiz games, students learn while having fun,
            and parents stay connected to their children&apos;s educational journey.
          </motion.p>
          ...
          >
            ...
            <div className="card card-hover p-6 text-left">
              ...
              <h3 className="text-xl font-heading font-semibold mb-2 text-neutral-900">For Teachers</h3>
              <p className="text-neutral-600">
                Create engaging quizzes, host live game sessions, and track student progress effortlessly.
              </p>
            </div>
            ...
            <div className="card card-hover p-6 text-left">
              ...
              <h3 className="text-xl font-heading font-semibold mb-2 text-neutral-900">For Students</h3>
              <p className="text-neutral-600">
                Join exciting quiz games, compete with classmates, and learn while having fun!
              </p>
            </div>
            ...
            <div className="card card-hover p-6 text-left">
              ...
              <h3 className="text-xl font-heading font-semibold mb-2 text-neutral-900">For Parents</h3>
              <p className="text-neutral-600">
                Monitor your children&apos;s progress, view detailed statistics, and stay connected.
              </p>
            </div>
          </motion.div>
        </motion.div>
      ...
      <footer className="border-t border-neutral-200 py-8 text-center text-neutral-600">
        <p>© 2026 EduQuiz. Making learning fun and interactive.</p>
      </footer>
    </div>
  );
}
