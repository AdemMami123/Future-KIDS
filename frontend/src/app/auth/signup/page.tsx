    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-3 sm:p-4 md:p-6 py-8 sm:py-12">
      <div className="w-full max-w-4xl">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-2">Create Your Account</h1>
          <p className="text-sm sm:text-base text-gray-600 px-4">Join thousands of learners on their educational journey</p>
        </motion.div>
